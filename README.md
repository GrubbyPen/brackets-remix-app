...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create brackets-remix-app-1520
  fly apps create brackets-remix-app-1520-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app brackets-remix-app-1520
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app brackets-remix-app-1520-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'brackets-remix-app-1520-staging' does not match app name in config file 'brackets-remix-app-1520'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name brackets-remix-app-1520-db
  fly postgres attach --app brackets-remix-app-1520 brackets-remix-app-1520-db

  fly postgres create --name brackets-remix-app-1520-staging-db
  fly postgres attach --app brackets-remix-app-1520-staging brackets-remix-app-1520-staging-db
  ```
